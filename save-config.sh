#!/bin/bash
#Script to save the modified configuration as modified_pi2_aarch64_virt_defconfig and linux kernel configuration.
#Author: Siddhant Jajoo.

cd `dirname $0`
source shared.sh
mkdir -p base_external/configs/
make -C buildroot savedefconfig BR2_DEFCONFIG=${ISDR_MODIFIED_DEFCONFIG_REL_BUILDROOT}
